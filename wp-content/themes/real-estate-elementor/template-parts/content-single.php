...
<?php 
$display_author = get_theme_mod('real_estate_elementor_enable_author_single_section',true); 
$display_comment = get_theme_mod('real_estate_elementor_enable_comment_single_section',true); 
$display_date = get_theme_mod('real_estate_elementor_enable_date_single_section',true); 
$display_tags = get_theme_mod('real_estate_elementor_enable_tags_single_section',true); 
$display_image = get_theme_mod('real_estate_elementor_enable_fimage_single_section',true); 
?>
    ...
    <?php //if(class_exists( 'WooCommerce')) { ?> 
        ...
        <ul class="post-meta text-left">
            ...
            <li>
                ...
                <?php real_estate_elementor_posted_on(); ?>
            </li>
            <?php } ?>
