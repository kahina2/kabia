...
<div class="texture-option-area">
        <div class="texture-option-top-hdr">
            <div class="col-1">
                <div class="logo-img">
                <a target="_blank" href="<?php echo $theme_header['theme_brand_url']; ?>/?wp=real-estate-elementor" class=""> <span class="logo-image"><?php echo $theme_header['theme_brand']; ?></span></a>
            </div>
            </div>
            <div class="col-2">
                ...
                <span><?php echo _e('FREE THEME','real-estate-elementor'); ?></span>
            </div>
        </div>
        <div class="texture-option-bottom-hdr">
            <a class="tablinks <?php echo esc_attr($tabActiveWl) ?>" onclick="openTab(event, 'Welcome')"><?php _e('Welcome','real-estate-elementor');?></a>
            <a class="tablinks <?php echo esc_attr($tabActiveRp) ?>" onclick="openTab(event, 'Recommended-Plugin')"><?php _e('Recommended Plugin','real-estate-elementor');?> </a>
            <a class="tablinks <?php echo esc_attr($tabActiveImportDc) ?>" onclick="openTab(event, 'Import-Demo-Content')"><?php _e('Demo Import','real-estate-elementor');?> </a>
        </div>
        ...
        <?php include('welcome.php' ); ?>
          ...
          <div id="Import-Demo-Content" class="tabcontent <?php echo esc_attr($tabActiveImportDc) ?>">
            ...
            <div class="rp-two-column">
                ...
                <h3><?php _e('Click Here To Import Demo Content','real-estate-elementor'); ?></h3>
				 
				 <p> <?php _e('You need to Install required plugins like- Wptexture Customizer, WooCommerce and One click demo import plugin. After installing required plugins import button will activate.', 'real-estate-elementor'); ?></p>
              <a href="<?php echo admin_url( 'themes.php?page=one-click-demo-import' ); ?>" class="button ztabtn"><?php _e( 'Import Demo', 'real-estate-elementor' ); ?></a>
