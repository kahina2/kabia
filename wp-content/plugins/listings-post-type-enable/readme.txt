...
A simple plugin that creates a "listings" custom post type. It is also add a recent listings custom widget and a new category listings widget, in the widget dashboard.
...
1. Upload the `listings-post-type-enable` folder to the `/wp-content/plugins/` directory
...
* Added category listings widget
